<div class="birthday-section section-b-space event-sec bg-size blur-up lazyloaded" style="background-image: url(&quot;images/event-bg.jpg&quot;); background-size: cover; background-position: center center; background-repeat: no-repeat; display: block;">
    <img src="images/event-bg.jpg" class="img-fluid blur-up lazyload bg-img" alt="birthday" style="display: none;">
    <div class="birthday-top">
        ...
        <div class="setting">
            <div class="setting-btn light-btn">
                <a href="#" class="d-flex">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-rotate-cw icon icon-light stroke-width-3 iw-11 ih-11"><polyline points="23 4 23 10 17 10"></polyline><path d="M20.49 15a9 9 0 1 1-2.12-9.36L23 10"></path></svg>
                </a>
            </div>
    ...
    <div class="birthday-content">
        <div class="image-section">
            <div class="event-group">
                <div class="center-profile bg-size blur-up lazyloaded" style="background-image: url(&quot;images/user-sm/3.jpg&quot;); background-size: cover; background-position: center center; background-repeat: no-repeat; display: block;">
                    <img src="images/user-sm/3.jpg" class="img-fluid blur-up lazyload bg-img" alt="user" style="display: none;">
                </div>
                <div class="center-profile bg-size blur-up lazyloaded" style="background-image: url(&quot;images/user-sm/5.jpg&quot;); background-size: cover; background-position: center center; background-repeat: no-repeat; display: block;">
                    <img src="images/user-sm/5.jpg" class="img-fluid blur-up lazyload bg-img" alt="user" style="display: none;">
                </div>
                <div class="center-profile bg-size blur-up lazyloaded" style="background-image: url(&quot;images/user-sm/2.jpg&quot;); background-size: cover; background-position: center center; background-repeat: no-repeat; display: block;">
                    <img src="images/user-sm/2.jpg" class="img-fluid blur-up lazyload bg-img" alt="user" style="display: none;">
                </div>
                <div class="center-profile bg-size blur-up lazyloaded" style="background-image: url(&quot;images/user-sm/1.jpg&quot;); background-size: cover; background-position: center center; background-repeat: no-repeat; display: block;">
        ...
        <div class="details">
            ...
            <form>
                ...
                <button type="submit">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-right icon-light icon stroke-width-3 iw-13 ih-13"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg>
                </button>
            </form>
        </div>
    </div>
